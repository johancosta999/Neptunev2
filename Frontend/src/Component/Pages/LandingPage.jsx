...
/** Water-friendly palette (keeps things professional & modern) */
const c = {
  deep: "#0B2A3B",   // deep navy
  ocean: "#0E7490",  // teal-600
  aqua: "#38BDF8",   // sky-400
  mint: "#14B8A6",   // teal-500
  foam: "#D0F3FF",   // soft highlight
};
...
export default function LandingPage() {
  return (
    <Box
      sx={{
        minHeight: "100dvh",
        // full-page gradient so there are NO white bands between sections
    ...
    >
      ...
      {/* HERO — image removed, keeps copy + waves, no white break below */}
      <Box
        id="hero"
        sx={{
          position: "relative",
      ...
      >
        ...
        >
          <path
            d="M0,160 C300,220 520,60 820,100 C1100,138 1280,110 1440,70 L1440,0 L0,0 Z"
            fill="currentColor"
          />
        </Box>
        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={8}>
              <Typography
                variant="h2"
                sx={{ fontWeight: 900, letterSpacing: "-.6px", mb: 1, animation: `${fadeUp} .6s both` }}
              >
              ...
              >
                Efficiently monitor, manage, and conserve water resources with
                real-time analytics, leak detection, and smart control.
              </Typography>
        ...
        {/* smooth wave into next colored section (no white gap) */}
      ...
      {/* ABOUT — glass over gradient */}
      <Container id="about" sx={{ py: { xs: 5, md: 7 } }}>
        <Paper
          elevation={0}
          sx={{
            p: { xs: 3, md: 5 },
      ...
      {/* FEATURES — circular glow badges + hover */}
                ...
                <Box sx={{ display: "flex", alignItems: "center", mb: 1.5 }}>
                  <Box
                    sx={{
                      ...
                      background:
                        `radial-gradient(circle at 30% 30%, ${c.mint}AA, ${c.mint}55 60%, transparent 70%)`,
                      color: "#06202B",
                    }}
                  >
                    {f.icon}
      ...
      {/* TANKS — product cards, dark glass, hover lift */}
      <Container id="tanks" sx={{ py: 6 }}>
        <Typography variant="h4" align="center" sx={{ fontWeight: 900, color: "#fff", mb: 3 }}>
          Our Tank Packages
        </Typography>
      ...
      {/* TEAM — glass cards with hover */}
      <Container id="team" sx={{ py: 6 }}>
        <Typography variant="h4" align="center" sx={{ fontWeight: 900, color: "#fff", mb: 3 }}>
          Meet Our Team
        </Typography>
        <Grid container spacing={4} justifyContent="center">
